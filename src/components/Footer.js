...
// ✅ src/assets/img 에 넣은 파일을 코드로 import
import bnr2 from '../assets/img/ft_offline_bnr2.jpg';
import mark0 from '../assets/img/ft_mark0.gif';
import mark2 from '../assets/img/ft_mark2.gif';
import mark3 from '../assets/img/ft_mark3.gif';
    ...
    <footer className='footer'>
      <div className="footerTop">
        <div className="delivery">
          ...
          <p>월~금 : am 11 ~ pm 5&nbsp;&nbsp;점심시간 : pm 12 ~ 1 <br />(토/일/공휴일은 휴무)</p>
        </div>
        ...
        <div className="notice">
          ...
          <p className='pmargin'>Copyright (c) ATTRANGS. All Rights Reserved.</p>
        </div>
        ...
        <div className="onlyAttrangs">
          ...
          {/* ✅ import한 이미지를 사용 */}
          <img src={bnr2} alt="오프라인 배너" loading="lazy" />

          <div className="tit">SOCIAL</div>
          <ul>
            <li className='i'><Link to="#"></Link></li>
            <li className='f'><Link to="#"></Link></li>
            <li className='y'><Link to="#"></Link></li>
            <li className='c'><Link to="#"></Link></li>
          </ul>
        </div>
      </div>
      ...
      <div className='footerBot'>
        <div className="footerNav">
          ...
          <div className="footerImgs">
            <ul>
              <li>
                <Link to="#">SN Fashion Group.Co.Ltd Info</Link>
              </li>
              {/* ✅ import한 마크 이미지들 */}
              <li><Link to="#"><img src={mark0} alt="정품인증" loading="lazy" /></Link></li>
              <li><Link to="#"><img src={mark2} alt="이니시스" loading="lazy" /></Link></li>
              <li><Link to="#"><img src={mark3} alt="대한통운" loading="lazy" /></Link></li>
            </ul>
          </div>
        </div>
      </div>
